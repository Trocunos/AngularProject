...
export class LoginComponent implements OnInit {
  ...
  constructor(private router: Router, private readonly loginUsuarioService: LoginUsuarioService) { }
  ...
  loginUsuario(){
    ...
    this.loginUsuarioService.loginUsuario(data1).subscribe((data:any)=>{
